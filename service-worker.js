const CACHE = 'fat-v3-2026-07-18-42';
const CRITICAL = [
  '/',
  '/index.html',
  '/offline.html',
  '/manifest.webmanifest',
  '/theme-bootstrap.js?v=20260718-42',
  '/assets/site.css?v=20260718-42',
  '/app.js?v=20260718-42',
  ...
  '/assets/js/community-repositories.js?v=20260718-42',
  '/site.js?v=20260718-42',
...
const OPTIONAL = [
  ...
  '/calculator-tutorial.js?v=20260718-42',
  '/replica-utils.js?v=20260718-28',
  '/assets/js/share-link.js?v=20260718-29',
  '/assets/js/replica-card.js?v=20260718-42',
  '/assets/js/account-login.js?v=20260718-42',
  '/assets/js/account-login-entry.js?v=20260718-42',
  '/assets/js/turnstile-client.js?v=20260718-30',
  '/assets/js/armory.js?v=20260718-42',
  '/assets/js/armory-entry.js?v=20260718-42',
  '/assets/js/community-gallery.js?v=20260718-42',
