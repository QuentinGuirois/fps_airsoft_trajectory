const CACHE = 'fat-v3-2026-07-18-35';
const CORE = [
  '/',
  '/index.html',
  '/offline.html',
  ...
  '/assets/js/community-repositories.js?v=20260718-36',
  ...
  '/assets/js/replica-card.js?v=20260718-36',
  ...
  '/assets/js/simulation-link-snapshot.js?v=20260718-36',
  '/assets/js/armory.js?v=20260718-36',
  '/assets/js/armory-entry.js?v=20260718-36',
