...
test('le pipeline fige Lighthouse, archive ses rapports et differe HSTS includeSubDomains', async () => {
  ...
  assert.match(htaccess, /Header add Link "<\/assets\/site\.css\?v=20260723-47>; rel=preload; as=style"/);
...
test('les correctifs Lighthouse conservent des noms accessibles et une region publique nommee', async () => {
  ...
  for (const html of [home, gas, advanced, gallery]) {
    const preload = html.indexOf('<link rel="preload" href="/assets/site.css?v=20260723-47" as="style">');
    const bootstrap = html.indexOf('<script src="/theme-bootstrap.js?v=20260723-47" data-cfasync="false"></script>');
