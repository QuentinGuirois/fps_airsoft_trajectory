...
test('le service worker cache seulement les shells et contourne toutes les réponses API privées', async () => {
  ...
  assert.match(worker, /const CACHE = 'fat-v3-2026-07-18-41'/);
  for (const path of ['/compte/', '/compte/verifier-email.html', '/compte/compte-active.html', '/compte/armurerie.html', '/tu-joues-avec-quoi/', '/assets/site.css?v=20260718-41', '/assets/js/replica-card.js?v=20260718-41', '/assets/js/armory.js?v=20260718-41', '/assets/js/armory-entry.js?v=20260718-41', '/assets/js/account-login.js?v=20260718-41', '/assets/js/account-login-entry.js?v=20260718-41', '/assets/js/community-repositories.js?v=20260718-41', '/assets/js/community-gallery.js?v=20260718-41', '/assets/js/turnstile-client.js?v=20260718-30']) {
