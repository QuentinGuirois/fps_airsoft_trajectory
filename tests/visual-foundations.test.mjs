...
test('chaque page initialise le thème dans le head avant la feuille de style', async () => {
  ...
  for (const path of files) {
    ...
    const initPosition = html.indexOf('<script src="/theme-bootstrap.js?v=20260718-42" data-cfasync="false"></script>');
    const cssPosition = html.search(/<link rel="stylesheet" href="\/assets\/site\.css\?v=20260718-42">/);
...
test('les polices officielles, licences et modules visuels sont disponibles hors ligne sans CDN', async () => {
  ...
  assert.match(sw, /const CACHE = 'fat-v3-2026-07-18-42'/);
